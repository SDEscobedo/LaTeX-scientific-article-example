%Nota: La creación de este projecto puede verse en el curso de LaTeX 
%en nuestro canal de YouTube: https://www.youtube.com/c/4Science
%Creando un artículo científico desde cero con LaTeX
%Creación del proyecto:Salvador D. Escobedo
%Licencia de uso: MIT

% Importante: 
%  Este artículo se realizó como un ejercicio del uso de LaTeX
%  basado en el artículo de Siyang Li y George Smoot, a quienes
%  pertenecen todos los derechos del artículo científico.
%  El artículo original puede verse en: https://arxiv.org/pdf/2012.00132.pdf
...
\usepackage[total={18cm,24cm},centering]{geometry} %Genera nuevos márgenes en el documento
\usepackage{natbib} %Provee de funcionalidades para el uso de archivos .bib para las referencias.
\setcitestyle{super,open={},close={},citesep={,}} %Define el estilo de las citas
\usepackage[colorlinks,citecolor=blue,linkcolor=blue,urlcolor=blue]{hyperref} %Provee funcionalidades para el uso de hipervincluos.
\usepackage{graphicx} %Provee de funcionalidades para el uso de gráficos y archivos de imagen.
\usepackage{tabularx} %Extiende las capacidades del entorno tabular.
\usepackage{titlesec} %Permite asignar estilos a los títulos y subtítulos.
\titleformat*{\section}{\bf\centering\MakeUppercase} %Define el estilo de los subtítulos (\section)
\usepackage{authblk} %Provee funcionalidades para la presentación los autores.

%El siguente código define el comando blankfootnote para notas en un formato personalizado
%+++++++++++++++++++++++++++++++++++++++++++
...
%Estableciendo el título del artículo.
...
%El formato de los autores requiere el paquete authblk (ver arriba)
\author[a]{Siyang Li} 
...
\date{} %La fecha debe ir en blanco si queremos omitirla
